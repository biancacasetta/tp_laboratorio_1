...
int menu()
{
    ...
    printf("2. Limpiar los datos de los empleados de la lista\n");
    printf("3. Alta de empleado\n");
    printf("4. Modificar datos de empleado\n");
    printf("5. Baja de empleado\n");
    printf("6. Listar empleados\n");
    printf("7. Ordenar empleados\n");
    printf("8. Sobreescribir empleado ya dado de alta\n");
    printf("9. Forzar alta de empleado en una posición determinada\n");
    printf("10. Crear sublista de empleados\n");
    printf("11. Separar empleado de la lista\n");
